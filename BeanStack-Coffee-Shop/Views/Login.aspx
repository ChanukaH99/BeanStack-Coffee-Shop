<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Cafe_Managemnt.View.Login" %>
...
<body class="m-0 p-0 overflow-hidden font-sans bg-cover bg-no-repeat" style="background-image: url('../Images/Login.jpg');">
    <form id="form1" runat="server">
        <div class="w-[450px] bg-white/50 mt-[150px] mx-auto p-10 rounded-[15px] shadow-md text-center">
            ...
            <div class="text-left mb-5 pl-5 font-serif">
                <asp:CheckBox ID="chkRemember" runat="server" />
                <label for="chkRemember">Keep me logged in</label>
            </div>

            <asp:Button ID="btnLogin" runat="server" Text="Sign in"
                CssClass="w-[90%] p-2 bg-blue-500 text-white rounded-lg cursor-pointer font-serif hover:bg-blue-700" />
